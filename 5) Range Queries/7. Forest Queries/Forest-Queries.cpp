...
/*
    *Thought Process*
    ...
    Prefix sum in 2D
    submission lind- https://cses.fi/paste/d90c0324f21893e165f8fd/
*/
...
signed main() {
    ...
    auto __solve_testcase = [&](int testcase) -> void {
        ...
        for(int i = 1; i <= q; i++){
            ...
            int treesInGrid = prefix[y[2]][x[2]] - prefix[y[2]][x[1]-1] - prefix[y[1]-1][x[2]] + prefix[y[1]-1][x[1]-1]; 
